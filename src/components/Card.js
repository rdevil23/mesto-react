...
function Card({ card, name, link, likes, onCardClick, onCardLike, onCardDelete }) {
  ...
  return (
    <li className="elements__item">
      {isOwn && <img src={deleteBtn} onClick={handleDeleteClick} className={cardDeleteButtonClassName} alt="кнопка 'удалить'" />}
      ...
      <div className="elements__info">
        ...
        <div className="elements__likes-wrapper">
          <button onClick={handleLikeClick} className={cardLikeButtonClassName} type="button" aria-label="кнопка 'нравится'"></button>
